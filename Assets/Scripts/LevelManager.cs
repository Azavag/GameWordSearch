...
public class LevelManager : MonoBehaviour
{
    ...
    { "ßÁËÎÊÎ", "ÌÀÒĞ¨ØÊÀ", "ÊĞÅÏÎÑÒÜ", "ÑÊÎĞÎÑÒÜ",
      "ÊÎÒ", "ÎÁÎÍßÍÈÅ", "ÆÈÂÎÒÍÎÅ", "ÇÎÎËÎÃÈß", "ÏÎËÎÂÈÍÀ", "ÊÎÌÍÀÒÀ",
      "ÑÎÁÀÊÀ", "ÏÎÂÅÑÒÜ", "ÁÀÑÑÅÉÍ", "ÇÀÏßÒÀß", "ĞÅÁ¨ÍÎÊ", "ÑÂÀÄÜÁÀ",
      "ÑÒÓË", "ÃĞÓÁÈßÍ", "ÎÑÒÀÒÎÊ", "ÔÅÂĞÀËÜ", "ÀÏĞÅËÜ", "ÌÀÉ",
      "ßÍÂÀĞÜ","ÌÀĞÒ","ÈŞÍÜ", "ÈŞËÜ", "ÀÂÃÓÑÒ",
      "ÑÅÍÒßÁĞÜ","ÎÊÒßÁĞÜ","ÍÎßÁĞÜ", "ÄÅÊÀÁĞÜ", "ÄÂÎÉÍÈÊ",
      "ÑÒÎË", "ÍÈÊÎÒÈÍ", "ÑÛĞÍÈÊ", "ÏĞÈÌÅÒÀ", "ÏËÀÍÅÒÀ",
      "ÄÅĞÅÂÎ", "ĞÓËÅÒÊÀ", "ÏÈÀÍÈÍÎ", "ÒÅĞÅÌÎÊ", "ÌÈÇÈÍÅÖ",
      "ÓËÈÖÀ", "ÑËÎÍ", "ÊĞÈÒÈÊ", "ÁÅËÓÃÀ", "ÃĞÓÏÏÀ",
      "ÃÎĞÎÄ", "ËÅÂ", "ËÜÂÈÖÀ", "ÍÅÄÅËß", "ÁÎĞÎÂ",
      "ÒĞÀÂÀ", "ÖÂÅÒÎÊ", "ÏÎËßÍÀ", "ËÓÃ", "ÁÓÒÎÍ",
      "ÁÅĞ¨ÇÀ", "ÎÑÈÍÀ", "ÒÎÏÎËÜ", "ÄÓÁ", "ÊË¨Í",
      "ÏÀĞÒÀ", "ÄÎÑÊÀ", "ĞÀÄÈÓÑ", "ÒÅÒĞÀÄÜ", "Ó×ÅÁÍÈÊ",
      "ËÀÌÏÀ", "ÓÑËÓÃÀ", "ÏÅÄÀËÜ", "ÊĞÅÊÅĞ", "ÊÎÑÓËß",
      "ÊÎĞÎÂÀ", "ÂÀÊÓÓÌ", "ÎÑÒĞÎÂ", "ÒÅĞÌÈÍ", "ÎÑ¨ÒĞ",
      "ËÈÑÒ", "ÂÅÒÊÀ", "ÊÎĞÀ", "ÇÅËÅÍÜ", "ÂÅĞØÈÍÀ",
      "ÊÎĞÅÍÜ", "ÆÓÊ", "ÊÓÑÒ", "ÄÓÏËÎ", "ÁÅËÊÀ",
      "ÌÀØÈÍÀ", "ÁÓËÊÀ", "ÕËÅÁ", "ÁÀÒÎÍ",
      "×ÀÑÛ", "ÍÎÆ", "ÒÎÏÎĞ", "ÏÅÍÜ", "ÏÀËÊÀ",
      "ÍÎÆÍÈÖÛ", "ÀÄ", "ÀÑ", "¨Æ", "ÓÆ",
      "ĞÓ×ÊÀ",
      "ËÎÆÊÀ",
      "ÂÈËÊÀ",
    ...
    //Î÷èòñêà ïîñëåäíåé ââåä¸ííîé áóêâû ñëîâà
    ...
    //Ïîëó÷åíèå ğåæèìà îò ïîëüçîâàòåëÿ
    ...
    {              
        ...
        NextLvlPanel.gameObject.SetActive(true);
    ...
    private List<string> SelectRandomWords(List<string> themeWordList, int count)
    {
        ...
        // Ïğîâåğÿåì, ÷òî â ñïèñêå äîñòàòî÷íî ñëîâ äëÿ âûáîğà
