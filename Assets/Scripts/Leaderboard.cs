...
public class Leaderboard : MonoBehaviour
{
    ...
    public void GetEntries(string jsonEntries)
    {
        ...
        playerEntry.transform.Find("EntryBackground/Name").GetComponent<TextMeshProUGUI>().text = "ВЫ";
        ...
        playerEntry.transform.Find("EntryBackground/PlaceBack/PlaceText").GetComponent<TextMeshProUGUI>().text = userRank;
